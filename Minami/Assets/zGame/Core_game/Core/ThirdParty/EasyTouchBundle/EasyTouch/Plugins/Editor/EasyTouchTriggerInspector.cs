...
namespace Lam.zGame.Core_game.Core.ThirdParty.EasyTouchBundle.EasyTouch.Plugins.Editor
{
	...
	public class EasyTouchTriggerInspector : UnityEditor.Editor {
		...
		public override void OnInspectorGUI(){
			...
			string[] eventNames = Enum.GetNames( typeof(Engine.EasyTouch.EvtType) ) ;
			...
			for (int i=1;i<eventNames.Length;i++){
				...
				Engine.EasyTouch.EvtType ev = (Engine.EasyTouch.EvtType)Enum.Parse( typeof(Engine.EasyTouch.EvtType), eventNames[i]);
			...
			if (index!=0){
				...
				t.AddTrigger( (Engine.EasyTouch.EvtType)Enum.Parse( typeof(Engine.EasyTouch.EvtType), eventNames[index]));
		...
		private void TriggerInspector(Engine.EasyTouch.EvtType ev, EasyTouchTrigger t){
		...
		private void AddEvent(Engine.EasyTouch.EvtType ev, EasyTouchTrigger t){
