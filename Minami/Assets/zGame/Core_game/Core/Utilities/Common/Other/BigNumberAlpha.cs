    ...
    public class BigNumberAlpha : IComparable<BigNumberAlpha>
    {
        ...
        public BigNumberAlpha(string pValue)
        {
            ...
            else
            {
                ...
                {
                    Debug.Debug.LogError("Could not convert value " + parts[0]);
                }
            }
        ...
        public BigNumberAlpha Divide(BigNumberAlpha pNumber)
        {
            ...
            if (pNumber.readableValue == 0)
            {
                Debug.Debug.LogError("Could not divide to Zero!");
                return this;
            }
        ...
        public int ToInt()
        {
            if (pow <= 0)
            {
                ...
                {
                    Debug.Debug.LogError("Value is too big that can not be Integer!");
                    return 0;
                }
            }
            else
            {
                ...
                Debug.Debug.LogError("Value is invalid, can not be Integer! " + valueStr);
                return int.MaxValue;
            }
        }
        ...
        public string GetString(bool pStripDecimal = true)
        {
            ...
            else
            {
                ...
                {
                    Debug.Debug.LogError("Number should never have more than one dot!");
                    return "0";
                }
            }
        }
