...
namespace Lam.zGame.Core_game.Core.Utilities.Common
{
    [System.Serializable]
    public class AssetsList<T> where T : Object
    {
        ...
        public T GetAsset(string pName)
        {
            ...
            Debug.Debug.LogError(string.Format("Not found {0} with name {1}", typeof(T).Name, pName));
            return defaultAsset;
        }
        ...
        public T GetAsset(int pIndex)
        {
            ...
            {
                Debug.Debug.LogError(string.Format("Index {0} {1} is invalid!", pIndex, typeof(T).Name));
                return defaultAsset;
            }
