...
namespace Lam.zGame.Core_game.Core.Utilities.Components.UI
{
    public class ProgressBar : MonoBehaviour
    {
        ...
        public bool isUseCuston;
        public float sizeWidthCuston;
        /// <summary>
        ...
        private void FillBar(float pValue)
        {
            if (fillByBarWidth)
            {
                if (imgBackground != null)
                {
                    if (isUseCuston)
                    {
                        mBackgroundSize = new Vector2(sizeWidthCuston, imgBackground.rectTransform.rect.height);
                    }
                    else
                    {
            ...
            if (fillByBarWidth)
            {
                if (mRectProgressValue == null && imgProgressValue != null)
                {
