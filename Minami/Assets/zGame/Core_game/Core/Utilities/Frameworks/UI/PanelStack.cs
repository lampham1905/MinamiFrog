    ...
    public class PanelStack : MonoBehaviour
    {
        ...
        public PanelController TopPanel
        {
            get
            {
                if (panelStack.Count > 0) {
                    //Debug.LogError("aaaaaaaaaaaaaaaa  : "+ panelStack.Count);
        ...
        public int Index
        {
            get
            {
                ...
                {
                    int i = 0;
                    var enumerator = mParentPanel.panelStack.GetEnumerator();
        ...
        internal virtual void PopPanel(bool actionSameTime = true)
        {
            ...
            //UnityEngine.Debug.Log(topStack.name + " : " + topStack.IsShowing);
        ...
        {
            var panel = CreatePanel(ref pPanel);
            //UnityMainThreadDispatcher.Instance().Enqueue(PushPanelToTop, panel);
            PushPanelToTop(panel);
            return panel;
        }
        ...
        internal virtual void PushPanelToTop(PanelController panel)
        {
            ...
            panel.Show();
            OnAnyChildShow(panel);
            //CoroutineUtil.StartCoroutine(ShowPanelPushTop(panel));
        }
        IEnumerator ShowPanelPushTop(PanelController panel)
        {
        ...
        internal virtual void PopChildrenThenParent()
        {
            ...
            {
                //UnityEngine.Debug.Log(this.TopPanel.TopPanel.name + " :day la cai gi nhi");
