...
namespace Lam.zGame.Core_game.Core.Utilities.Frameworks.Data
{
    public class DataManager : MonoBehaviour
    {
        ...
        /// </summary>
        protected Dictionary<string, List<DataGroup>> mMainGroups = new Dictionary<string, List<DataGroup>>();
        ...
        {
            //Debug.LogError("saveeeee ");
            //if (pForce
                //|| Time.time - mLastTimeSave > MIN_TIME_BETWEEN_SAVES
                //)
            {
                //Debug.LogError("saveeeee 11111");
        ...
        public virtual void PushLocalDataToServer() { }    
