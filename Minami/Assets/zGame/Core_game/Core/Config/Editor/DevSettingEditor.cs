...
using Lam.zGame.Core_game.Core.Utilities.Editor.Builder;
using UnityEditor;
...
namespace Lam.zGame.Core_game.Core.Config.Editor
{
    ...
    public class DevSettingEditor : UnityEditor.Editor
    {
        ...
        private void DrawFirebaseConfiguration()
        {
            ...
            {
                FirebaseDevConfigPath = EditorHelper.FileSelector("Dev Config Fire", "FirebaseDevConfigPath", "json,txt");
                FirebaseLiveConfigPath = EditorHelper.FileSelector("Live Config Fire", "FirebaseLiveConfigPath", "json,txt");
                ...
                EditorHelper.BoxHorizontal(() =>
                {
                    ...
                    EditorHelper.Button("Use Live Config", () =>
                    {
                        ...
                        using (StreamReader reader = theSourceFile.OpenText())
                        {
                            ...
                            var contentNode = JSON.Parse(content);
